...
chcp 65001 >nul
echo ====================================
echo 停止 SpatialSRE-Agent 服务
echo ====================================
echo.

REM 停止 FastAPI 服务
echo [1/4] 停止 FastAPI 服务...
taskkill /FI "WINDOWTITLE eq SpatialSRE-Agent API*" /F >nul 2>&1
if errorlevel 1 (
